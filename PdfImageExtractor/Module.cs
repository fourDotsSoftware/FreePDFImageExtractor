...
namespace PdfImageExtractor
{
    class Module
    {
        public static Bitmap imgmona = (Bitmap)Bitmap.FromFile(Application.StartupPath + "\\mona_portrait.jpg");
        ...
        public static string UserDocumentsFolder = System.Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\4dots Free PDF Image Extractor";
        ...
        public static string CmdPassword = "";
        ...
        public static string PresetFile = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\PdfImageExtractor\Presets.xml";
